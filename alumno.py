...
class Alumno(Arreglo):
    def __init__(self, nombre=None, apellido=None, edad=None, matricula=None, calificacion=None, sexo=None, es_objeto=None):
        if nombre is None and apellido is None and edad is None and matricula is None and calificacion is None and sexo is None:
    ...
    def actualizarPromedio(self, calificacion):
        self.calificacion = calificacion
    ...
    def __str__(self):
        ...
        return (f"Alumno: {self.nombre} {self.apellido}, {self.edad} años, "
                f"Matrícula: {self.matricula}, Promedio: {self.calificacion}, Sexo: {self.sexo}")
