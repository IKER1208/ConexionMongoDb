...
class InterfazAlumno:
    ...
    def agregar_alumno(self):
        ...
        datos_para_guardar = [alumno.convertir_diccionario()]
    ...
    def actualizar_alumno(self):
        try:
            ...
            if 0 <= indice < len(self.alumnos.items):
                ...
                self.actualizar_en_mongo(alumno)
            else:
                print("Índice fuera de rango.")
        except ValueError:
            print("Entrada inválida.")

    def actualizar_en_mongo(self, alumno):
        ...
        if client:
            ...
            try:
                coleccion.update_one(
                    ...
                    {"$set": alumno.convertir_diccionario()}
                )
                print("Alumno actualizado en MongoDB.")
    ...
    def guardar_en_mongo_o_local(self, datos):
        ...
        if client:
            ...
            try:
                ...
                print(" Alumnos offline limpiados después de sincronización.")
            except Exception as e:
